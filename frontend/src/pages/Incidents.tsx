...
import { AlertCircle, Plus, Clock, X } from 'lucide-react'
import {
  incidentsApi,
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <select
          ...
          className="glass rounded-md px-3 py-1.5 text-sm text-horus-ivory bg-transparent border border-white/10"
        >
...
function CreateIncidentModal({
  ...
  return (
    ...
    >
      <div
        className="glass rounded-lg p-6 w-full max-w-lg space-y-4"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-horus-ivory">New Incident</h2>
