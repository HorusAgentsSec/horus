            ...
            <div className="glass border border-white/10 rounded-lg overflow-hidden">
              <div className="flex border-b border-white/10">
                ...
                <div className="ml-auto flex items-center pr-3">
                  <button onClick={() => setShowEditor(false)} className="text-white/30 hover:text-white/70 text-xs px-2 py-1 rounded hover:bg-white/10 transition-colors">
                    Cancel
                  </button>
                </div>
              </div>
                  ...
                  <>
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <select value={aiObjective} onChange={e => setAiObjective(e.target.value as typeof aiObjective)}
                          className="w-full bg-white/5 border border-white/10 rounded px-3 py-1.5 text-sm text-white focus:outline-none focus:border-horus-gold">
                          <option value="click">Link click (urgency / curiosity)</option>
                          <option value="credentials">Credential harvest (fake login)</option>
                          <option value="report">Report test (suspicious email)</option>
                        </select>
                      </div>
                    </div>
        ...
        <div className="glass border border-white/10 rounded-lg p-4 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-white/5 border border-white/10 rounded px-3 py-1.5 text-sm text-white focus:outline-none focus:border-horus-lapis"
            >
              <option value="">— Generate with AI (using asset context)</option>
              {templates.map(t => (
