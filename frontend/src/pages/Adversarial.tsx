...
const CATEGORIES = ['', 'dns', 'ssl', 'headers', 'exposed_path', 'subdomain', 'breach', 'exploit', 'network', 'attack_chain', 'other'] as const
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Select
          ...
          options={CATEGORIES.map((c) => ({ value: c, label: c ? c.replace('_', ' ') : 'All categories' }))}
        />
      </div>
