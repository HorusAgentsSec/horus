...
4. Think about attack chains: can weaknesses be combined into a more severe scenario?
5. Save real findings using save_red_finding. Do NOT save informational observations. \
